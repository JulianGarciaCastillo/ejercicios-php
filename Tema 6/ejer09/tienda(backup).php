...
if ($_COOKIE == null){
  ...
  // Comprimir array a string y guardar en cookies.
    cookieArrayToCookie($articulos,'catalogo_articulos');
  // Descomprimir string a array.
    //cookieStringToArray($articulos);
  ...
  if ($nombre == "admin"){
    ...
    //alta($articulos, "elfine", "El fin es mi principio", 15, "elfine.jpg");
    //baja($articulos,"lasdvi");
    //modificacion($articulos, "elfine", "El fin es mi principio", 22, "elfine.jpg");

    //setcookie("catalogo_articulos", $articulos);
